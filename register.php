...
if (isset($_POST["sign_up"])){
        ...
        $passwordHash = password_hash($mot_de_pass, PASSWORD_DEFAULT);
        ...
        if (mysqli_num_rows($resultat) > 0){
            ...
            $requete  = "INSERT INTO CLIENT(nom,prenom,genre,adress,num_tel,email,Password)
                    VALUES ('$nom','$prenom','$genre','$adress','$num_tel','$email','$passwordHash')";
            mysqli_query($connect, $requete); 
            echo "<div class = 'sucess'>Account Created Succesfully!</div>";
...
?>
<!--Sign in / Login form-->
<img src ="https://i.pinimg.com/736x/40/be/7a/40be7ac5f2943b1fa1573c1b968f97f3.jpg">
